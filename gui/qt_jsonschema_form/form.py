...
class WidgetBuilder:
    ...
    def create_form(self, schema: dict, ui_schema=None, state=None, parent=None) -> widgets.FormWidget:
    ...
    def get_widget_variant(self, schema_type: str, schema: Dict[str, Any], ui_schema: Dict[str, Any]) -> str:
        try:
            if isinstance(schema_type, list):
                default_variant = self.widget_variant_modifiers[schema_type[0]](schema)
            else:
